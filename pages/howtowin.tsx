        ...
        return (
            <>
                ...
                <div className="mx-auto flex max-w-6xl flex-row items-center justify-center py-2 w-full mb-24">
                    ...
                    Receive 10 DigiPoints for every <a href="https://www.adobe.com/express/" target="_new" title="Adobe Express" style="text-decoration: underline;">Adobe Express</a> license you sell
                    </div>
                </div>
