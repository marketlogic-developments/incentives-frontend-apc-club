...
const comunicado = () => {
  ...
  const exampleDataPromociones = [
    ...
    },
    {
      paragraph: [
        {
          ...
          isList: true,
          paragraphList: [
            "Durante el período del FY23 acumularás tus DigiPoints de la siguiente manera:",
          ],
        },
        {
          paragraph:
            "Nuevos negocios y renovaciones 10 DigiPoints por cada USD 1,000 FOB, en ventas a canales Gold.",
          isBold: false,
          isList: false,
          paragraphList: [
            "Vende, gana y redime en Junio 2023 y tus Digipoints valen el doble en establecimientos seleccionados vende, gana y redime en Junio 2023 y tus Digipoints valen el doble en establecimientos seleccionados vende, gana y redime en Junio 2023 y tus Digipoints valen el doble en establecimientos seleccionados vende, gana y redime en Junio 2023 y tus Digipoints valen el doble en establecimientos seleccionados vende, gana y redime en Junio 2023 y tus Digipoints valen el doble en establecimientos seleccionados.",
            "Lore ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis ",
          ],
        },
      ],
      ...
      rightImage: "",
      leftImage: "/assets/dashboard/banners/celebra.jpg",
      publishedDate: "Publicado el 24 de mayo 2023 a las 14:00 horas.",
      ...
      summary:
        "Obtener y redimir tus DigiPoints es muy fácil. Te mostramos cómo es el proceso y la forma en la que llegan a tu cuenta para que puedas redimir tus premios en los establecimientos afiliados.",
      articleEnd:
        "¡Te motivamos a enfocar tus esfuerzos de ventas para redimir todos los premios que te mereces!",
    },
  ];
