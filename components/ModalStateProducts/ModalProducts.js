  ...
  return (
    <div className="flex flex-col gap-5 w-[90%] mx-auto">
            ...
            <div className="w-28 flex justify-center flex-col items-center">
              ...
              >
                <path
                  ...
                  stroke={active === 3 || active === 5 ? "#1473E6" : "#BABABA"}
                  stroke-width="1.73963"
                  stroke-linecap="round"
                  stroke-linejoin="round"
                />
      ...
      <div>
        ...
        <p className="!text-sm">
          ID {data.orderNumber} - {data.CreatedAt.split("T")[0]}
        </p>
      </div>
      ...
      <ContditionsProviders data={data.productsObject} />
    </div>
  );
};
